...
@section('main-content')
    <div class="row">
        <div class="col-xs-12 col-md-12">
            <div class="text-left">
                <button type='button' id="add" class='ver btn bg-olive right'><i
    ...
    <div class="box">
        ...
        <div class="box-body">
            <table id="listaActividades" class="table table-bordered table-striped dataTable" cellpadding="3" cellspacing="2">
                <thead>
                <tr>
                    <th>nº</th>
                    <th></th>
